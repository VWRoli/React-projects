export const projects = [
  {
    ...
    desc: [
      'Designed and implemented the entire frontend of a Guitar E-Commerce website, featuring a compare and cart section. ',
      'Developed a paginated product display with filtering, sorting, and search functionalities.  ',
  ...
  },
  {
    ...
    frontendUrl: 'https://github.com/VWRoli/bitewise-frontend',
    backendUrl: 'https://github.com/VWRoli/bitewise-backend',
    desc: [
      'Meal Planner app with technologies like React, NextJS, Tailwind and Mterial-UI. ',
      'Backend technologies are NestJS, TypeORM and MySQL. ',
      'Full password authentication server side with NextJS.',
    ],
  },
  // {
  //   id: 1,
